...
mean(iris_with_missing$Sepal.Length,na.rm=T)
...
There are `r ncol(iris_fill_miss)` rows and `r nrow(iris_fill_miss)` columns in the `iris` dataset. The mean of `Sepal.Length` is `5.82`, `Sepal.Width` is `3.08`, `Petal.Length` is `3.77` and `Petal.Width` is `1.19`
